        ...
        {auth ? (
          <div className="flex items-center flex-col gap-10">
            ...
            <div className="flex flex-wrap justify-center">
              {schoolDataList2 || [].map((schoolData, index) => <Cards key={schoolData._id || index} title={schoolData.title} _id={schoolData._id} availability={schoolData.availability ? "Available" : "Unavailable"} thumbnail={`http://localhost:3000/${schoolData.thumbnail}`} />)}
            </div>
          </div>
        ) : (
